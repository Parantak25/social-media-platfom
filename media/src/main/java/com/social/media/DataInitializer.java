...
public class DataInitializer {
    ...
    public CommandLineRunner initializeData() {
        return args -> {
            ...
            // Create some posts
            MediaPost post1 = new MediaPost();
            MediaPost post2 = new MediaPost();
            MediaPost post3 = new MediaPost();
            ...
            // Save posts to the database (assuming you have a SocialPostRepository)
